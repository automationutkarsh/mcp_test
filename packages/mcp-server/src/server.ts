...
import { ClientOptions } from 'mcp-test';
...
export { ClientOptions } from 'mcp-test';
...
export function initMcpServer(params: {
  ...
  const client = new McpTest(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new McpTest({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
